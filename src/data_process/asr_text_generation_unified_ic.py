...
if __name__ == "__main__":
    ...
    instructions = ["Determine the primary purpose of the text and evaluate how clearly and effectively the message is conveyed",
                    "Identify the main intent of the text and assess the clarity and effectiveness of its delivery",
                    "Ascertain the fundamental objective of the text and critique the transparency and efficiency of its presentation",
                    "Figure out the chief aim of the text and judge how lucidly and effectively the ideas are presented",
                    "Assess the central purpose of the text and evaluate the directness and impact of its expression"]
